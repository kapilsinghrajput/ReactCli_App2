  ...
  return (
    <LinearGradient colors={['#e65c00', '#F9D423']} 
      ...
      <View className="flex flex-row items-center md:items-end  justify-center ">
        <Text style={{fontSize:deviceWidth*0.06}} className='  md:text-4xl text-white p-2 md:py-5 '>पूजा</Text>
        ...
        <Text style={{fontSize:deviceWidth*0.06}} className=' md:text-4xl text-white  p-2 md:py-5 '>विधी</Text>
      </View>

      <View className="flex flex-row gap-0">
        {/* <MaterialCommunityIcons name="magnify" color={"white"} size={22} /> */}
        <Icon onPress={onShareHandler} name="share-variant" color={"white"} size={deviceWidth*0.08} />
      </View>
    </LinearGradient>
